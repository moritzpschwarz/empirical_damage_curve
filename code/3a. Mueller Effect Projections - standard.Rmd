...
<!-- knitr::purl(here("code","3a. Mueller Effect Projections - realisations.Rmd"),output = here("code","3a. Server_Mueller.R")) -->
<!-- ``` -->
...
foreach(v=1:coefsamples,.packages = loadedNamespaces()) %dopar% {
  ...
  save(done,file = here("data","temp","projections",paste0("full_Mueller_gets_",v,".RData")))
  rm(done,i)
}
```
...
foreach(v=1:coefsamples,.packages = loadedNamespaces()) %dopar% {
  ...
  save(done,file = here("data","temp","projections",paste0("full_Mueller_BHM_",v,".RData")))
  rm(done,i)
}
```
...
foreach(v=1:coefsamples,.packages = loadedNamespaces()) %dopar% {
  ...
  save(done,file = here("data","temp","projections",paste0("full_Mueller_LASSO_",v,".RData")))
  rm(done,i)
}
```
